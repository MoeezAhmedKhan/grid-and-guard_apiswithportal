            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © <span id="year"></span> <a href="javascript:void(0)"></a>. Design & Developed <span class="text-danger"></span> by <a href="javascript:void(0)"> <a href="" target="_blank">Sas Solution</a> </a> All rights reserved.
                    </div>
                </div>
            </div>
        </footer>            <!-- FOOTER END -->
