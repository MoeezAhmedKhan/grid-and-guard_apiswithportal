                                ...
                                <table id="example" class="table table-bordered border text-nowrap mb-0 display nowrap" id="basic-edit">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                               ...
                                               $t_id = $_GET['id'];
                                               $sql = "SELECT `id`,`title`, `name`, `description`, `estimated_cost`, `additional_cost`, `pickup_location`, `status` FROM `task_details` WHERE `task_id` = $t_id";
                                                    ...
                                                    while($rec = mysqli_fetch_array($exec))
                                                    {
                                                        $sn = $index+1;
                                                         ...
                                                         echo '<tr>
                                                                    ...
                                                                    <td>'.$rec['additional_cost'].'</td>
                                                                    <td>'.$rec['pickup_location'].'</td>
                                                                    <td name="status">'.$rec['status'].'</td>
                                                                </tr>';
                    ...
                    <form method="POST" action="phpfiles/action.php">
                        ...
                        <div class="form-row">
                            <div class="col-xl-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="status" id="Status" id="validationDefault01">
                            </div>
                        </div>
