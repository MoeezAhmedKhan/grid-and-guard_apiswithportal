                            ...
                            <!-- ROW-1 -->
                                ...
                                <!--vendor start-->
                                    ...
                                    <div class="row">
                                        ...
                                        <h2 class="side-menu__icon page-title">Vendors</h2>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <p class="font-medium-2">Total Vendors</p>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where role_id = '3' and status = 'active'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                       ...
                                                       <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Active Vendors</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where role_id = '3' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Suspended Vendors</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1">
                                ...
                                <!--vendor end-->
                                    ...
                                    <!--Business customer start-->
                                    
                                    <div class="row">
                                        
                                        <h2 class="page-title">Business Customers</h2>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Business Customer</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where status = 'active' and role_id = 2";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Active Business Customer</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where status = 'suspended' and role_id = 2";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Suspended Business Customer</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                    ...
                                    <!--Individual customer start-->
                                        
                                        
                                    <div class="row">
                                        
                                        <h2 class="page-title">Individual Customers</h2>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Individual Customer</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where role_id = '1' and status = 'active'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Active Individual Customer</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where role_id = '1' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num   ?></h2>
                                                            <p class="font-medium-2">Total Suspended Individual Customer</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Guards</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where role_id = '4' and status = 'active'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Active Guard</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `user` where role_id = '4' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num  ?></h2>
                                                            <p class="font-medium-2">Total Suspended Guard</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                    ...
                                    <!--                <div class="d-flex">-->
                                                        ...
                                                        ?>
                                        <!--                 <div class="mt-2">-->
                                        <!--                    <h2 class="mb-0 number-font mb-2"><?php ?></h2>-->
