<?php
  session_start();
  if(isset($_SESSION["role"]) && $_SESSION["role"] == '0' || $_SESSION["role"] == '3') /*|| $_SESSION["role"] == "Staff"*/
  {
                ...
                <div class="">
                    ...
                    <div class="container-login100">
                        <div class="wrap-login100 p-6">
                            <form class="login100-form validate-form" action="phpfiles/authenticate.php" method="POST">
