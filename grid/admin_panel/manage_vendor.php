                                                    ...
                                                    while($rec = mysqli_fetch_array($exec))
                                                    {
                                                        $sn = $index+1;
                                                         ...
                                                         echo '<tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-list">
                                                                            <a href="edit_vendor.php?id='.$rec['id'].'"><button id="bEdit" type="button" class="btn btn-sm btn-primary"><span class="fa fa-edit"></span></button></a>
                                                                            <a href="delete_vendor.php?id='.$rec['id'].'"><button id="bDelete" type="button" onclick="" class="btn btn-sm btn-primary"><span class="fa fa-trash"></span></button></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>';
