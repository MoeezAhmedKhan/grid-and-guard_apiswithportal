                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Individual Edit</h1>
                                <div>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Individual Edit</li>
                                    </ol>
                                </div>
                            </div>
                            <!-- PAGE-HEADER END -->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="phpfiles/action.php" method="POST">
                                                ...
                                                <button class="btn btn-primary" type="submit" name="update_individual_account_btn">Create</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
