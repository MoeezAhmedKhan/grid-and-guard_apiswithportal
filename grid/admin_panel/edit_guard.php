                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Guard Edit</h1>
                                <div>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Guard Edit</li>
                                    </ol>
                                </div>
                            </div>
                            <!-- PAGE-HEADER END -->
                                            ...
                                            <form action="phpfiles/action.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-xl-6 mb-3">
                                                        ...
                                                        <select class="form-select form-control" name="service" id="validationDefault04">
                                                            <option selected disabled value="">Select</option>
                                                            <option value="armed" <?php if($rec["service"] == "armed"){echo "selected";} ?> >armed</option>
                                                            <option value="unarmed" <?php if($rec["service"] == "unarmed"){echo "selected";} ?> >unarmed</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                 ...
                                                 <div class="form-row">
                                                    <div class="col-xl-12 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="<?php echo $rec['profile'] ?>" name="old_image">
                                                    </div>
                                                </div>
                                                ...
                                                <button class="btn btn-primary" type="submit" name="update_guard_account_btn">Create</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
