                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Create Bussiness Account</h1>
                                <div>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Create Bussiness Account</li>
                                    </ol>
                                </div>
                            </div>
                            <!-- PAGE-HEADER END -->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="phpfiles/insertions.php" method="POST">
                                                ...
                                                <button class="btn btn-primary" type="submit" name="add_business_account_btn">Create</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>                  
