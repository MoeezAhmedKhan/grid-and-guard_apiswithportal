<?php
    ...
    $friend_id = $_POST['guard_id'];
    $task_id = $_POST['task_id'];
    $type = $_POST['type'];
    include('connection.php');
    
    $sql_getData = "SELECT `m_id`, `sender_id`, `reciever_id`, `Data`, `last_message`, `is_read`, `status`, `created_at` FROM `messages` WHERE `reciever_id` = '$friend_id' AND `sender_id` = '$userid' AND `task_id` = $task_id AND `type` = '$type'";
